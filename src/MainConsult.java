...
//        prologRepositorio.InsertRecipe(receta);
        ...
        SchemeRepositorio schemeRepositorio = SchemeRepositorio.SchemeRepository();
        Float imc = schemeRepositorio.IMC(76.0f, 165.0f);
        Float grasa = schemeRepositorio.CalculargrasaCorporalHombre(imc, 20);
        System.out.println(imc);
        System.out.println(grasa);
        Float sc = schemeRepositorio.CalcularCaloriasAumentarPesoFemenino("Sedentario",76.0f, 165.0f,20);
